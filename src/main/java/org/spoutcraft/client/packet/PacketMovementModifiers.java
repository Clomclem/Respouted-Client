...
public class PacketMovementModifiers implements SpoutPacket {
	...
	public void run(int playerId) {		
		MinecraftClient.getInstance().thePlayer.getData().setGravityMod(gravityMod);
		MinecraftClient.getInstance().thePlayer.getData().setWalkingMod(walkingMod);
		MinecraftClient.getInstance().thePlayer.getData().setSwimmingMod(swimmingMod);
		MinecraftClient.getInstance().thePlayer.getData().setJumpingMod(jumpingMod);
		MinecraftClient.getInstance().thePlayer.getData().setAirspeedMod(airspeedMod);
	}
