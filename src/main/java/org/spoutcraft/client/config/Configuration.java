...
public class Configuration {
	...
	private static void updateMCConfig() {
		MinecraftClient.getInstance().gameSettings.ambientOcclusion = Configuration.isAmbientOcclusion() ? 2 : 0;
		MinecraftClient.getInstance().gameSettings.anaglyph = Configuration.isAnaglyph3D();
		MinecraftClient.getInstance().gameSettings.renderDistance = Configuration.getRenderDistance();
		MinecraftClient.getInstance().gameSettings.fancyGraphics = Configuration.isFancyGraphics();
		MinecraftClient.getInstance().gameSettings.advancedOpengl = Configuration.getAdvancedOpenGL() !=0;
		MinecraftClient.getInstance().gameSettings.guiScale = Configuration.getGuiScale();
		MinecraftClient.getInstance().gameSettings.viewBobbing = Configuration.isViewBobbing();
		MinecraftClient.getInstance().gameSettings.gammaSetting = Configuration.getBrightnessSlider();

		MinecraftClient.getInstance().gameSettings.limitFramerate = Configuration.getPerformance();
