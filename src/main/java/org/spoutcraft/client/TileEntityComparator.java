...
public class TileEntityComparator implements Comparator<TileEntity>{
	private int playerX = MathHelper.floor_double(MinecraftClient.getInstance().thePlayer.posX);
	private int playerY = MathHelper.floor_double(MinecraftClient.getInstance().thePlayer.posY);
	private int playerZ = MathHelper.floor_double(MinecraftClient.getInstance().thePlayer.posZ);
