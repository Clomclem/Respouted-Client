...
public class SpoutItem extends Item {
	...
	@Override
	public ItemStack onItemRightClick(ItemStack item, World world, PlayerEntity player) {
	...
	@Override
	public boolean onItemUse(ItemStack stack, PlayerEntity player, World world, int x, int y, int z, int face, float xOffset, float yOffset, float zOffset) {
	...
	public boolean onItemUse(ItemStack item, CustomBlock block, PlayerEntity player, World world, int x, int y, int z, int side, float xOffset, float yOffset, float zOffset) {
