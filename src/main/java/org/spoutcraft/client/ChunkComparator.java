...
public class ChunkComparator implements Comparator<Chunk>{
	private int playerX = MathHelper.floor_double(MinecraftClient.getInstance().thePlayer.posX / 16.0D);
	private int playerZ = MathHelper.floor_double(MinecraftClient.getInstance().thePlayer.posZ / 16.0D);
