...
public class SpoutcraftWorld {
	private final net.minecraft.world.World handle;

	public SpoutcraftWorld(net.minecraft.world.World world) {
		handle = world;
	}
	...
	public int getMixedBrightnessAt(org.spoutcraft.api.material.Block block, int x, int y, int z) {
		net.minecraft.block.Block b = null;
		if (block.getRawId() < net.minecraft.block.Block.blocksList.length) {
			b = net.minecraft.block.Block.blocksList[block.getRawId()];
		}
		if (b == null) {
			b = net.minecraft.block.Block.stone;
		}
	...
	public List<SpoutPlayer> getPlayers() {
		...
		for (Object mcentity:handle.loadedEntityList) {
			if (mcentity instanceof net.minecraft.entity.player.PlayerEntity) {
				ret.add((SpoutPlayer) ((net.minecraft.entity.player.PlayerEntity)mcentity).spoutEnty);
			}
		}
		return ret;
	}
	...
	public boolean isMultiplayerWorld() {
		return MinecraftClient.getInstance().isMultiplayerWorld();
	}
