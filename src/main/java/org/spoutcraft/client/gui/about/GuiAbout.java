...
public class GuiAbout extends GuiScreen {
	...
	public void drawScreen(int x, int y, float z) {
		...
		GL11.glDisable(2896 /*GL_LIGHTING*/);
		GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
		MinecraftClient.getInstance().getTextureManager().bindTexture(new ResourceLocation("gui/gui.png"));		
		...
		MinecraftClient.getInstance().getTextureManager().bindTexture(new ResourceLocation("textures/gui/title/mojang.png"));		
		GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
		GL11.glPushMatrix();
	...
	private void overlayBackground(int var1, int var2, int var3, int var4) {
		...
		MinecraftClient.getInstance().getTextureManager().bindTexture(new ResourceLocation("gui/background.png"));
		GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
		float var6 = 32.0F;
