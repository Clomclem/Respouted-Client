...
public class InvertMouseButton extends GenericCheckBox {
	public InvertMouseButton() {
		super("Invert Mouse");
		setChecked(MinecraftClient.getInstance().gameSettings.invertMouse);
		setTooltip("Invert Mouse\nInverts the mouse movement.");
	}

	@Override
	public void onButtonClick() {
		MinecraftClient.getInstance().gameSettings.invertMouse = !MinecraftClient.getInstance().gameSettings.invertMouse;
