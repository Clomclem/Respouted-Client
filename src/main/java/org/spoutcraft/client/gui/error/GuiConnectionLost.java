...
class ReconnectButton extends GenericButton {
	public void onButtonClick() {
		MinecraftClient.getInstance().displayGuiScreen(new GuiConnecting(MinecraftClient.getInstance(), GuiConnectionLost.lastServerIp, GuiConnectionLost.lastServerPort));
	}
}
