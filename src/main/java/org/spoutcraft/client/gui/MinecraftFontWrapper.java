...
public class MinecraftFontWrapper implements MinecraftFont {
	...
	public void drawString(String text, int x, int y, int color) {
		MinecraftClient.getInstance().fontRenderer.drawString(text, x, y, color);
	}

	public void drawCenteredString(String text, int x, int y, int color) {
		MinecraftClient.getInstance().fontRenderer.drawString(text, x, y - getTextWidth(text) / 2, color);
	}

	public void drawShadowedString(String text, int x, int y, int color) {
		MinecraftClient.getInstance().fontRenderer.drawStringWithShadow(text, x, y, color);
	}
}
