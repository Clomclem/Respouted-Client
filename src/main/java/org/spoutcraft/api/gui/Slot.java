...
public interface Slot extends Control {
    ...
    /**
     * Returns if Spoutcraft will render the amount of items in the {@link net.minecraft.item.ItemStack} within the slot
     * @return True if the slot renders item amount, false if not
     */
    public boolean doesRenderAmount();

    /**
     * Sets if Spoutcraft will render the amount of items in the {@link net.minecraft.item.ItemStack} or not
